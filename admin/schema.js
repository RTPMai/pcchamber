...
export const COLLECTIONS = [
...

  {
    ...
    fields: [
      ...
      { id: 'tier', label: 'Membership level', type: 'select',
        options: ['individual', 'basic', 'partner', 'investor', 'sponsor', 'champion'],
        labels: { individual: 'Individual', basic: 'Basic Business', partner: 'Community Partner',
          investor: 'Community Investor', sponsor: 'Community Sponsor', champion: 'Community Champion' },
        help: 'What they pay for. Sets their place in the directory and what the benefits tracker counts against.' },
...

  {
    ...
    blurb: 'Chamber news, and the member spotlights that Investor members and up are promised.',
